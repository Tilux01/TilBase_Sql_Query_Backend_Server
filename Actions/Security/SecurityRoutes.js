...
const getSecurityOverview = async (req, res) => {
    ...
    try {
        ...
        const [networkResults] = await connection.query(networkCommand, [projectId]);
        ...
        const [historyResults] = await connection.query(historyCommand, [userId, projectId]);
...
const regenerateProfileKey = async (req, res) => {
    ...
    try {
        ...
        await connection.query(command, [newKey, userId]);
...
const regenerateProjectKey = async (req, res) => {
    ...
    try {
        ...
        await connection.query(command, [newKey, projectId, userId]);
